...
public class renewalLogin extends AppCompatActivity implements View.OnClickListener {
    ...
    String box,totAmountstr,lowbox,finalbox;;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbxXLZ_YtsY1nNesqJ0T-De2KqGTLSjegnjWP-KzjI_mKrDPBvs/exec",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        loading.dismiss();
                       // Toast.makeText(renewalLogin.this, response, Toast.LENGTH_LONG).show();
...
//SEARCH
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbxXLZ_YtsY1nNesqJ0T-De2KqGTLSjegnjWP-KzjI_mKrDPBvs/exec",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        loading.dismiss();
                        Toast.makeText(renewalLogin.this, response, Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                Map<String, String> parmas = new HashMap<>();
                //here we pass params
                parmas.put("action","onRenewClick2");
                parmas.put("Boxnum", finalbox);
                parmas.put("totAmount",totAmountstr);
    ...
    private void parseItems(String jsonResposnce) {
        ...
        String Name, Address,planName,Amount;
        int totAmount=50;
        ...
        try {
            ...
            for (int i = 0; i < jarray.length(); i++) {
                ...
                planName = jo.getString("planName");
                Amount = jo.getString("Amount");
                totAmount += Integer.parseInt(Amount);
        ...
        adapter = new SimpleAdapter(this,list,R.layout.planrow,
                new String[]{"planName","Amount"},new int[]{R.id.textViewPlanName,R.id.textViewAmount});
        //adapter = new SimpleAdapter(this,list,R.layout.listrow,
        //      new String[]{"Boxnum","Name","renewalOrPackChange","Amount","colDate","Notes"},new int[]{R.id.boxNumber,R.id.Name,R.id.renorchange,R.id.amntt,R.id.coldtee,R.id.ntss});
